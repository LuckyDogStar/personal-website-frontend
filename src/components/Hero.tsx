...
const Hero = () => {
    return (
        <div className="md:h-screen bg-cover bg-hero-lg h-screen flex flex-col justify-center items-center">
            ...
            <Link className='py-6 px-10 bg-indigo-500 rounded-full text-3xl hover:bg-indigo-300 transition duration-300 ease-in-out flex items-center animate-pulse' to="/contact" >Contact
