...
const Navbar = ({toggle}) =>{
    return(
       <nav className='px-3 flex justify-between items-center h-16 bg-white text-black relative shadow-sm font-montserrat' role ='navigation'>
           ...
           <div className="div.px-4.cursor-pointer hover:bg-purple-100 md:hidden"
           onClick={toggle}>
